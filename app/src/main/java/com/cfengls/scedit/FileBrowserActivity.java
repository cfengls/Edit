...
public class FileBrowserActivity extends ListActivity {
    ...
    int tabgeshu=Tabgeshu.getTabgeshu();
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (file.isDirectory()) {
            ...
            Tabgeshu.setTabgeshu(tabgeshu);
            YeKa.setYeKa(tabgeshu,file.getName());
            tabgeshu++;


            data.putExtra("neirong",FileUtil.readString(file.getPath(),"utf-8"));
            ...
            //Toast.makeText(FileBrowserActivity.this,str, Toast.LENGTH_SHORT).show();
